...
<div class="branding">
  ...
  <h1 class="m3-font-title-medium">
    {name}
    <a class="m3-font-title-medium" href={github}>GitHub</a>
    <a class="m3-font-title-medium" href="https://discord.gg/sRzVYM9b47">Discord</a>
  </h1>
  <p>{description}</p>
</div>
...
<style>
  .branding {
    --transition: var(--m3-util-curve) 500ms;
    display: flex;
